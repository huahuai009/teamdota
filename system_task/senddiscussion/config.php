...
//发表主题时发送邮件的模板
$_SC['discussion_data_template'] = '<table style="background-color: #ffffff; width: 100%; text-align: left; border-collapse: collapse; border-spacing: 0; -premailer-cellspacing: 0; -premailer-cellpadding: 0; -premailer-width: 100%; margin: 0; padding: 0; border: 0;" bgcolor="#ffffff" width="100%" cellpadding="0" cellspacing="0">
		<tr>
...
//发表评论时发送邮件的模板
$_SC['post_data_template'] = '<table style="background-color: #ffffff; width: 100%; text-align: left; border-collapse: collapse; border-spacing: 0; -premailer-cellspacing: 0; -premailer-cellpadding: 0; -premailer-width: 100%; margin: 0; padding: 0; border: 0;" bgcolor="#ffffff" width="100%" cellpadding="0" cellspacing="0">
	<tr>
		<td style="background-color: #ffffff; text-align: left; vertical-align: top; font-size: 12px; line-height: 19px; font-family: \'宋体\', helvetica, sans-serif; color: #000000;" align="left" bgcolor="#ffffff" valign="top">
			<p class="grey small project_meta" style="font-size: 12px; line-height: 16px; font-family: \'宋体\', helvetica, sans-serif; color: grey; margin: 10px 0;">
			  项目：\\1
			</p>
			...
			<table style="background-color: #ffffff; width: 100%; text-align: left; border-collapse: collapse; border-spacing: 0; -premailer-cellspacing: 0; -premailer-cellpadding: 0; -premailer-width: 100%; margin: 0; padding: 0; border: 0;" bgcolor="#ffffff" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td style="background-color: #ffffff; text-align: left; vertical-align: top; font-size: 12px; line-height: 19px; font-family: \'宋体\', helvetica, sans-serif; color: #000000;" align="left" bgcolor="#ffffff" valign="top">
						<h3 class="no_bottom_margin" style="font-weight: normal; font-family: \'宋体\', helvetica, sans-serif; font-size: 14px; line-height: 19px; margin: 6px 0 0;">
							<b>
								\\2
							</b>
						</h3>
			...
			<div class="main_content " style="border-top-width: 1px; border-top-color: #cccccc; border-top-style: solid; border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #cccccc; background-color: #ffffff; width: 100%; margin: 19px 0; padding: 15px 0;">
				<p class="brown comment_heading" style="font-size: 12px; line-height: 19px; font-family: \'宋体\', helvetica, sans-serif; color: brown; margin: 0 0 10px;">
					新的评论:
				</p>
				<table style="background-color: #ffffff; width: 100%; text-align: left; border-collapse: collapse; border-spacing: 0; -premailer-cellspacing: 0; -premailer-cellpadding: 0; -premailer-width: 100%; margin: 0; padding: 0; border: 0;" bgcolor="#ffffff" width="100%" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class="body" style="background-color: #ffffff; text-align: left; vertical-align: top; font-size: 12px; line-height: 19px; font-family: \'宋体\', helvetica, sans-serif; color: #000000;" align="left" bgcolor="#ffffff" valign="top">
							<div class="comment_content formatted_content" style="max-width: none !important; margin: 0; padding: 0;">
								<b class="person" style="display: block; margin: 4px 0;"><span>\\4</span></b>
								\\5
							</div>
