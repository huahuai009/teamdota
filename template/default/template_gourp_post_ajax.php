...
<article class="comment new">
	...
	<div  class="expanded_content" id="comment_after" style="display:none;padding-top:20px;">
		...
		<header class="text_entry_view">
			<textarea class="userData" name="message" id="qinbaba-ttHtmlEditor" style="height:100%;width:100%;display:none;border:0px" placeholder="添加评论..."></textarea>
		...
		<footer>
			...
			<div class="submit">
				...
				<div id="buttoncomment_<?=$objectid?>"><input type="button" id="issuance" data-behavior="issuance_save" onclick="validatepost('buttoncomment_<?=$objectid?>','newcomment_<?=$objectid?>','post_add');" value="发表评论"><span id="__newcomment_<?=$objectid?>"></span></div>
				<div id="__buttoncomment_<?=$objectid?>"></div>
			</div>
		</footer>
		</form>  
	</div>
